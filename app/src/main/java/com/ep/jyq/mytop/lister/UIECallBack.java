...
public abstract class UIECallBack<ResultType extends UIEResult> implements Callback.CacheCallback<ResultType> {
    private ToolbarActvitiy mContext;
    private Boolean isCache = false;
    private Boolean isshowing = true;

    public UIECallBack(ToolbarActvitiy context) {
        mContext = context;
    ...
    public UIECallBack(ToolbarActvitiy context, boolean isshowing) {
        mContext = context;
    ...
    public void onSuccess(ResultType result) {
        if (isCache) {
            ...
            mContext.showError();
            mContext.showSnackbar(result.getMsg());
        } else {
            mContext.showError();
            mContext.showSnackbar(result.getMsg());
        }
