        ...
        if (urls.length > 0) {
            ...
            for (int i = 0; i < length; i++) {
                if (i < length - 2) {
                    ...
                    GlideProxy.getInstance().loadImage(context, url, mImageViews[i + 1]);
            ...
            GlideProxy.getInstance().loadImage(context, urls[urls.length - 1], mImageViews[0]);
            GlideProxy.getInstance().loadImage(context, urls[0], mImageViews[length - 1]);
        }
    }
